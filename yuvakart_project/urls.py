"""
URL configuration for yuvakart_project project.
...
urlpatterns = [
    ...
    path('api/admin/verify-payment/', views.verify_razorpay_payment, name='verify-razorpay-payment'),
    path('api/admin/create-refund/', views.create_razorpay_refund, name='create-razorpay-refund'),
